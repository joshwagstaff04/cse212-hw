...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        //Check if the list is empty, If the list is empty, the new node is head and tail
        ...
        {
            //If not empty list then attach after current tail
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            //if the node matches then replace
    ...
    public IEnumerable Reverse()
    {
        ...
        //Go backwards through list until the front
        while (curr is not null)
        { 
